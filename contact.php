            ...
            <div class="d-flex">
                <?php
                  ...
                  if (isset($_SESSION['email'])) {
                      ...
                      echo '<a href="login.php" class="btn btn-outline-danger me-2" type="button">Connexion</a>
    ...
    <footer class="text-center bg-dark sticky-bottom">
        <div class="container text-white py-4 py-lg-5">
            <ul class="list-inline">
                ...
                <li class="list-inline-item me-4"><a class="link-light" href="formation.php">Formations</a></li>
                <li class="list-inline-item"><a class="link-light" href="contact.php">Contact</a></li>
            </ul>
            <ul class="list-inline">
            ...
            <p class="text-light mb-0">Copyright © 2023 Brand</p>
        </div>
    </footer>
